...
let website = "/fs.UnionCase"

let githubLink = "https://github.com/Update GitHome in build.fsx/fs.UnionCase"

// Specify more information about your project
let info =
  [ "project-name", "fs.UnionCase"
    "project-author", "robkuz"
    "project-summary", "helper functions for DiscriminateUnions"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/fs.UnionCase" ]
